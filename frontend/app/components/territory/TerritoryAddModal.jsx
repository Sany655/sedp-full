...
import { FaTimes, FaMapMarkerAlt, FaMapMarkedAlt } from "react-icons/fa";

const TerritoryAddModal = ({ isOpen, onClose, onSubmit, areas=[] }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-white">Add New Territory</h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
              <FaMapMarkedAlt className="inline w-4 h-4 mr-2 text-blue-600" />
              Area *
            </label>
            <select
              name="area_id"
...
export default TerritoryAddModal;
