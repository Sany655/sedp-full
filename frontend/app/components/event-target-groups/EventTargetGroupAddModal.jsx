 ...
 */
const EventTargetGroupAddModal = ({ isOpen, onClose, onSubmit, locations = [] }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const name = formData.eventtargetgroup_name.trim();
    const description = formData.eventtargetgroup_description.trim();
    ...
    const payload = {
      ...
      name,
      description,
      eventtargetgroup_name: name,
      eventtargetgroup_description: description,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-white">Add New Event Group</h2>
          </div>
          <button
            onClick={handleClose}
...
export default EventTargetGroupAddModal;