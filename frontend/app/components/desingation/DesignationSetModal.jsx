...
const DesignationSetModal = ({ 
    ...
    if (isOpen) {
      if (initialData) {
        setAssignmentData({
          ...
          designation_id: initialData.designation_id || null
        });
        ...
        // Set selected designation based on initial data
        const preSelectedDesignation = designations.find(designation => 
          designation.id === initialData.designation_id
        );
        setSelectedDesignation(preSelectedDesignation || null);
      } else {
        setAssignmentData({
          user_ids: [],
          designation_id: null
  ...
  }, [isOpen, initialData, users, designations]);
  ...
  const validateForm = () => {
    return (
      ...
      assignmentData.designation_id !== null
    );
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (!validateForm()) {
      toast.dismiss();
      toast.error('Please select at least one user and one designation');
      return;
    }

    const assignmentPayload = {
      user_ids: assignmentData.user_ids,
      designation_id: assignmentData.designation_id
    };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="max-h-48 overflow-y-auto border border-gray-200 rounded-md">
                {designations.map(designation => {
                  const isSelected = selectedDesignation?.id === designation.id;
                  return (
                    <div
                      key={designation.id}
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          name="designation"
                          checked={isSelected}
                          onChange={() => handleDesignationSelect(designation)}
            ...
            {/* Assignment Summary */}
            {selectedUsers.length > 0 && selectedDesignation && (
              <div className="bg-gray-50 p-4 rounded-md">
                <h4 className="font-medium text-sm text-gray-900 mb-2">Assignment Summary:</h4>
                <p className="text-sm text-gray-700">
                  You are about to assign the designation <span className="font-medium">"{selectedDesignation.name}"</span> to{' '}
...
export default DesignationSetModal;