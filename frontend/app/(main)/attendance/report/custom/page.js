import ViewTable from '@/app/components/attendance/ViewTable';
...
const page = async () => {
    ...
    return (
            <DefaultLayout title='Attendance Report'>
                <ViewTable renderFrom='custom' token={token} locations={locations.data} areas={areas.data} users={users.data} />
            </DefaultLayout>
